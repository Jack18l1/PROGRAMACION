...
<section class="content">
    <div class="container-fluid">
        ...
        <a href="?ctrl=CtrlAnexo5&accion=nuevo" class="btn btn-primary">
        ...
        <table class="table table-striped">
            ...
            <?php foreach ($data as $a) { ?>
                <tr>
                    ...
                    <td><?=$a['horario']?></td>
                    <td>
                        <a href="?ctrl=CtrlAnexo5&accion=editar&idAnexo5=<?=$a['idAnexo5']?>">
                            <i class="bi bi-pencil-square"></i> Editar</a>
                        / 
                        <a data-id="<?=$a['idAnexo5']?>" data-nombre="<?=$a['RUC']?>" class="eliminar" href="#">
