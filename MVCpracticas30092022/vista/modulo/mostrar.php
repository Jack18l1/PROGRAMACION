...
<section class="content">
    <div class="container-fluid">
        ...
        <a href="?ctrl=CtrlModulo&accion=nuevo" class="btn btn-primary">
        ...
        <table class="table table-striped">
            ...
            <?php foreach ($data as $a) { ?>
                <tr>
                    ...
                    <td><?=$a['idprograma']?></td>
                    <td>
                        <a href="?ctrl=CtrlModulo&accion=editar&idmodulo=<?=$a['idmodulo']?>">
                            <i class="bi bi-pencil-square"></i> Editar</a>
                        / 
                        <a data-id="<?=$a['idmodulo']?>" data-nombre="<?=$a['periodo']?>" class="eliminar" href="#">
